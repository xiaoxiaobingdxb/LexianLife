...
<div class="page-content clearfix">
                                ...
                                <td class="td-manage">
                                    <c:if test="${admin.status == 1}">
                                        <a onClick="member_stop(this,${admin.adminId})" href="javascript:;" title="停用"
                                           class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a></c:if>
                                    <c:if test="${admin.status == 0}">
                                        <a onClick="member_start(this,${admin.adminId})" href="javascript:;" title="启用"
                                           class="btn btn-xs btn-defaunt"><i class="fa fa-check  bigger-120"></i></a></c:if>
    ...
    <div id="add_administrator_style" class="add_menber" style="display:none">
        <form method="post" id="form-admin-add" action="/manager/admin/add_admin.do">
...
<script type="text/javascript">
    ...
    function statusChange(id, boolean) {
        $.ajax({
            url: '/manager/admin/change_status.do',
            type: 'POST',
            dataType : "JSON",
    ...
    function member_del(obj, id) {
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                url: '/manager/admin/delete_admin.do',
                type: 'POST',
                dataType : "JSON",
                data: { id : id},
                success : function (data) {
