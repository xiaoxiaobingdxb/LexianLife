...
<script>
    ...
    add = {
        ...
        "<a title=\"订单详细\" href=\"/manager/order/order_detailed.do?id=${orders.orderId}\" class=\"btn btn-xs btn-info order_detailed\" ><i class=\"fa fa-list bigger-120\"></i></a>"
...
function Delivery_stop(obj, id, status) {
    $.ajax({
        url: '/manager/order/change_status.do',
        type: 'POST',
        dataType : "JSON",
