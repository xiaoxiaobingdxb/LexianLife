...
<div class="margin clearfix">
 ...
 <div class="border clearfix">
       <span class="l_f">
        <a href="javascript:void()" class="btn btn-success Order_form"><i class="fa fa-check-square-o"></i>&nbsp;已退款订单</a>
     ...
     <a title="退款订单详细" href="/page/manager/order/Refund_detailed.jsp" class="btn btn-xs btn-info Refund_detailed" >详细</a>
