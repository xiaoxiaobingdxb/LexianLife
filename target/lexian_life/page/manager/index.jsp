...
<head>
    ...
    <!-- <![endif]-->
    <!--[if IE]>
    <script type="text/javascript">window.jQuery || document.write("<script s../../assets/js/jquery-1.10.2.min.js'>" + "<" + "script>");</script>
    <![endif]-->
    ...
    <script src="../../js/manager/jquery.nicescroll.js" type="text/javascript"></script>
            ...
            <ul class="nav ace-nav">
                <li class="light-blue">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        <li><a href="javascript:void(0)" name="page/manager/admin/admin_info.html" title="个人信息" class="iframeurl"><i
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    <li class="home"><a href="javascript:void(0)" name="/manager/home/index.do" class="iframeurl" title=""><i
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span
                        ...
                        <ul class="submenu">
                            ...
                            <li class="home"><a href="javascript:void(0)" name="/manager/product/category.do" title="分类管理"
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li class="home"><a href="javascript:void(0)" name="/manager/order/order_handling.do" title="订单处理"
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="/manager/customer/customer_list.do" title="会员列表"
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span
                        ...
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="/manager/admin/admin_list.do" title="管理员列表"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
                            <li class="home"><a href="javascript:void(0)" name="/manager/admin/admin_info.do" title="个人信息"
