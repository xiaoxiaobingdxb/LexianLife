            ...
            <div class="type_style">
                ...
                <div class="type_content">
                    <div class="Operate_btn">
                        <a href="javascript:void(0)" style="display: none"  id="add" class="btn  btn-warning"><i class="icon-edit align-top bigger-125"></i>新增子类型</a>
                        <a href="javascript:void(0)" style="display: none" id="delete" class="btn  btn-danger"><i class="icon-trash   align-top bigger-125"></i>删除该类型</a>
                    </div>
                    <%--<form action="" method="post" class="form form-horizontal" id="form-category-add">--%>
                        <div class="Operate_cont clearfix">
                            ...
                            <div class="formControls ">
                                ...
                                <input type="text" disabled="disabled" class="input-text" value="" placeholder="" id="showName" name="name">
                            </div>
                            <br>
                            <div class="formControls " id="sub-name" style="display: none" >
                                <label class="form-label"><span class="c-red">*</span>子类名称：</label>
                                <input type="text"  class="input-text" value="" placeholder="" id="new-sub-name" name="category-name">
                            </div>
                        </div>
                    <%--</form>--%>
...
//            }
    ...
    var zNodes =[
        ...
        { id:'1' + '${catalogList.key.catalog_id}', pId:1, name:"${catalogList.key.name}", "click":"par(${catalogList.key.catalog_id},'${catalogList.key.name}')"},
        <c:forEach items = "${catalogList.value}" var = "category" varStatus="state">
        { id: '2' + '${category.category_id}', pId:'1' + '${catalogList.key.catalog_id}', name:"${category.name}", "click":"sub(${category.category_id}, '${category.name}')"},
        </c:forEach>
        </c:forEach>
    ];
