...
<div class=" page-content clearfix">
    <div id="products_style" >
       ...
       <span class="l_f">
        <a href="/manager/product/product_add.do" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
       </span>
...
//            }
    ...
    var zNodes =[
        ...
        { id: '2' + '${category.category_id}', pId:'1' + '${catalogList.key.catalog_id}', name:"${category.name}", "click":"showCatagory(${category.category_id})"},
        </c:forEach>
        </c:forEach>
    ];
