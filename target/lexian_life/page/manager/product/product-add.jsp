    ...
    <div class="page_right_style">
        ...
        <form method="post"  enctype="multipart/form-data" id="form-article-add">
            ...
            <div class="form-group">
                ...
                <div class="formControls">
                    <input type="text" class="input-text" value="${goods.unitPrice}" placeholder="" id="unitPrice" name="unitPrice"
            ...
            <div class="form-group">
                ...
                <div class="formControls">
                    <input type="text" class="input-text" value="${goods.weight}" placeholder="" id="weight" name="weight"
            ...
            <div class="form-group">
                ...
                <div class="formControls">
                    <input type="text" class="input-text" value="${goods.inventory}" placeholder="" id="inventory" name="inventory"
                ...
                <div class="formControls">
                    <div id="attr">
                        <c:forEach items = "${goods.goodsAttrs}" var = "attrs" varStatus="state">
                            ...
                            <input style="display: none" value="${attrs.goodsAttrId}"  name='attrid'  class='input-text attr'  />
                        </c:forEach>
                    </div>
                </div>
                <div class="col-4"><span class="Validform_checktip"></span></div>
            ...
            <div class="form-group">
                <div class="formControls">
                    <input  style="display: none;" type="text" class="input-text" value="${goods.category.category_id}" placeholder="" id="categoryid" name="categoryid"
...
//                }
    ...
    var zNodes = [
        ...
        {id: '2' + '${category.category_id}', pId: '1' + '${catalogList.key.catalog_id}', name: "${category.name}", "click":"addCategory(${category.category_id})"},
        </c:forEach>
        </c:forEach>
    ];
