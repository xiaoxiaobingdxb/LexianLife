...
<body>
<c:if test="${sessionScope.modifyEmailFail!=null}">
    <%="<script>alert('"+session.getAttribute("modifyEmailFail")+"')</script>"%>
    <%
        session.removeAttribute("modifyEmailFail");
    %>
</c:if>
<header>
    <div class="topBox">
        ...
        <div class="center">
            <div class="col-main">
                <div class="main-wrap">
                    ...
                    <form class="am-form am-form-horizontal" action="/modifyEmail.do" method="post" id="form">
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" class="am-btn am-btn-success" onclick="sendMailMsg(this,'/sendModifyEmailEmail.do')">发送验证邮件</button>
                                    </div>
                                </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input type="email" id="user-email" placeholder="请输入新邮箱地址" name="email">
                            </div>
                        </div>
                        <div class="info-btn">
                            <div class="am-btn am-btn-danger" onclick="modifyEmail()">保存修改</div>
                        </div>
