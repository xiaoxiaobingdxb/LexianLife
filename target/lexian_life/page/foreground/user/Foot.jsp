                ...
                <div class="col-md-5">
                    <div class="searchBox">
                        ...
                        <ul class="list-inline">
                            ...
                            <li><a href="/viewCategory.do?category_id=${catalog.categories[0].category_id}&pageIndex=1">${sessionScope.catalogs[6].categories[0].name}</a> </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-2">
    ...
    <div class="container">
        <div class="center">
            <div class="col-main">
                ...
                <div class="s-more-btn i-load-more-item" data-screen="0" onclick="loadBrowseRecord()"><i class="am-icon-refresh am-icon-fw"></i>更多</div>
