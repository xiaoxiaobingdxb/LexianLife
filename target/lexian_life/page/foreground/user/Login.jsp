                ...
                <div class="login-box">
                    ...
                    <form action="/customerLogin.do" method="post" id="form">
                        <div class="user-name">
                            ...
                            <input type="text" name="username" id="username" placeholder="用户名" value="${sessionScope.username}">
                        </div>
                        <p style="color: rgb(218,70,35);font-size: 10px;">${requestScope.usernameWrong}&nbsp;</p>
                        <div class="user-pass">
                            <label for="password"><i class="am-icon-lock"></i></label>
                            <input type="password" name="password" id="password" placeholder="请输入密码" value="${sessionScope.password}">
                        </div>
                    ...
                    <div class="login-links">
                        <label for="rempsw1"><input id="rempsw1" type="checkbox" <c:if test="${'true'==sessionScope.remPsw}">checked</c:if>>记住密码</label>
                        <label for="auto-login" class="am-fr"><input id="auto-login1" type="checkbox" <c:if test="${'true'==sessionScope.autoLogin}">checked</c:if>>自动登录</label>
                        <br />
                    </div>
                    <div class="login-links">
