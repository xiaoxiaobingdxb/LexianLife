                                        ...
                                        <div class="order-list">
                                            ...
                                            <div class="order-status0" id="${order.orderId}">
                                                <div class="order-title">
                                                    ...
                                                    <span>成交时间：<cfm:formatDate value="${order.payTime}" pattern="yyyy-MM-dd"/></span>
                                                    <!--    <em>店铺：小桔灯</em>-->
                                                </div>
                                                    ...
                                                    <div class="order-left">
                                                        <c:forEach items="${order.orderItems}" var="orderItem">
                                                            <ul class="item-list">
                                                                <li class="td td-item">
                                                                <div class="item-pic">
                                                                    <a href="/viewGoods.do?goods_id=${orderItem.goods.goodsId}" class="J_MakePoint">
                                                                        <img src="${orderItem.goods.img}" class="itempic J_ItemImg">
                                                                    </a>
                                                                </div>
                                                                <div class="item-info">
                                                    ...
                                                    <div class="order-right">
                                                        ...
                                                        <div class="move-right">
                                                            ...
                                                            <li class="td td-change">
                                                                <div class="am-btn am-btn-danger anniu" onclick="deleteOrder(${order.orderId})">
                                                                    删除订单</div>
                                                            </li>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="order-list">
                                            <c:forEach items="${requestScope.waitPayOrders}" var="order">
                                                <div class="order-status1">
                                                    <div class="order-title">
                                                        <div class="dd-num">订单编号：<a href="javascript:void(0);">${order.orderNum}</a></div>
                                                ...
                                                <div class="order-content">
                                                    ...
                                                    <div class="order-right">
                                                        ...
                                                        <div class="move-right">
                                                            ...
                                                            <li class="td td-change">
                                                                <div class="am-btn am-btn-danger anniu" onclick="sendRemindSend()">
                                                                    提醒发货</div>
                                                            </li>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="order-content">
                                                    ...
                                                    <div class="order-right">
                                                        ...
                                                        <div class="move-right">
                                                            ...
                                                            <li class="td td-change">
                                                                <a class="am-btn am-btn-danger anniu" href="/confiremRec.do?orderId=${order.orderId}">
                                                                    确认收货</a>
                                                            </li>
                                                        </div>
                                                    </div>
