            ...
            <div class="clearfixLeft" id="clearcontent">
                <div class="box">
                    ...
                    <div class="tb-booth tb-pic tb-s310">
                        <a href="../../../img/goodsImg/${requestScope.viewGoods.goodsId}_s_1.jpg"><img src="../../../img/goodsImg/${requestScope.viewGoods.goodsId}_m_1.jpg" alt="" class="jqzoom" rel="../../../img/goodsImg/${requestScope.viewGoods.goodsId}_b_1.jpg" style="cursor: crosshair;"></a>
                    </div>
                    <ul class="tb-thumb" id="thumblist">
                        <c:forEach begin="1" end="5" varStatus="status">
                            <li <c:if test="${status.index==1}">class="tb-selected"</c:if>>
                            <div class="tb-pic tb-s40">
                                <a href="#"><img src="../../../img/goodsImg/${requestScope.viewGoods.goodsId}_s_${status.index}.jpg" mid="../../../img/goodsImg/${requestScope.viewGoods.goodsId}_m_${status.index}.jpg" big="../../../img/goodsImg/${requestScope.viewGoods.goodsId}_b_${status.index}.jpg"></a>
                            </div>
                        </li>
                        </c:forEach>
                    </ul>
                ...
                <div class="tb-detail-list">
                    ...
                    <ul class="tm-ind-panel">
                        <li class="tm-ind-item tm-ind-sellCount canClick">
                            <div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count">${requestScope.monthSaleCount}</span></div>
                        </li>
                        <li class="tm-ind-item tm-ind-sumCount canClick">
                            <div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">${requestScope.viewGoods.saleCount}</span></div>
                        </li>
                        <li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
                            <div class="tm-indcon"><span class="tm-label">累计评价</span><span class="tm-count">${requestScope.goodCount+requestScope.midCount+requestScope.badCount}</span></div>
                        </li>
                    </ul>
                    <div class="clear"></div>
                    ...
                    <dl class="iteminfo_parameter sys_item_specpara">
                                    ...
                                    <form class="theme-signin" name="loginform" action="" method="post">
                                        ...
                                        <div class="theme-signin-left">
                                            ...
                                            <div class="theme-options">
                                                <table>
                                                    <tr>
                                                        <td><div class="cart-title">单位</div></td>
                        ...
                        <dd>
                            ...
                            <span id="Stock" class="tb-hidden">库存<span class="stock">${requestScope.viewGoods.inventory}</span>${requestScope.viewGoods.unit}</span>
                        </dd>
