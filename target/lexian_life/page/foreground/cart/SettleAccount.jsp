...
<article>
    <div class="container">
        <div class="myCartBox">
            <div class="h2">结算</div>
            <div class="notLogin"><span class="glyphicon glyphicon-warning-sign">&nbsp;</span>温馨提示：订单中存在不支持7天无理由退换商品，请确认相关商品信息后提交订单。</div>
        </div>
                ...
                <div class="user-address">
                    ...
                    <ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails">
                        <c:forEach var="recAddr" items="${sessionScope.recAddrs}">
                            <li class="user-addresslist" id="${recAddr.recaddrId}" onclick="selectAddress(${recAddr.recaddrId})">
                                ...
                                <div class="new-mu_l2a new-p-re">
                                    <p class="new-mu_l2cw">
                                        ...
                                        <span class="province" id="province${recAddr.recaddrId}">${recAddr.province}</span>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="../../../img/goodsImg/${orderItem.goods.img}" width="100" height="150">
                                    </div>
                                    <div class="col-md-8">
        ...
        <div class="account pull-right">
            ...
            <a href="/submitOrder.do"><button type="button" class="submitOrder">提交订单</button></a>
        </div>
    </div>
</article>
<footer>
