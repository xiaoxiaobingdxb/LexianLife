        ...
        <div class="take-delivery">
            <div class="status">
                ...
                <div class="successInfo">
                    <ul>
                        <li>付款金额<em>¥${sessionScope.order.amount+sessionScope.order.logisticsFee+sessionScope.order.serviceFee}</em></li>
                        <div class="user-info">
                            <p>收货人：${sessionScope.order.recAddr.recName}</p>
                            <p>联系电话：${sessionScope.order.recAddr.phone}</p>
                            <p>收货地址：${sessionScope.order.recAddr.province} ${sessionScope.order.recAddr.city} ${sessionScope.order.recAddr.district} ${sessionScope.order.recAddr.addr}</p>
                        </div>
