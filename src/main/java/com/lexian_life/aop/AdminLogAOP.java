...
public class AdminLogAOP {
    ...
    @Autowired
    private AdminLogService adminLogService;//日志记录Service
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        try {
            ...
            adminLog.setOperate((joinPoint.getTarget().getClass().getName() + "." + joinPoint.getSignature().getName() + "()"));
