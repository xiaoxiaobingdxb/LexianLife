...
public class OrderController {
     ...
     * @param response
     */
    @RequestMapping(value = "/selectPayway",method = {RequestMethod.GET})
     ...
     * @param response
     */
    @RequestMapping(value = "/payNotPayedOrder",method = {RequestMethod.GET})
     ...
     * @return
     */
    @RequestMapping(value = "/confiremRec",method = {RequestMethod.GET})
