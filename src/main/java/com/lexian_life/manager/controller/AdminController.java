...
public class AdminController {
     ...
     * @return {
     *     "status" : "0:成功，1：验证码错误，2：用户名或密码错误，或账户已被冻结"，
     *     "msg" : "错误信息"
     * }
     */
    ...
    public Map<String, Object> login(HttpSession session, String username, String password, String verifyCode) {
