...
<div class="page-content clearfix">
 <div class="state-overview clearfix">
          ...
          <div class="title_name">订单统计信息</div>
           ...
           <tbody>
           <tr><td class="name">已付款：</td><td class="munber"><a href="#">${payed}</a>&nbsp;个</td></tr>
           <tr><td class="name">待发货订单：</td><td class="munber"><a href="#">${nosend}</a>&nbsp;个</td></tr>
           <tr><td class="name">已成交订单数：</td><td class="munber"><a href="#">${finished}</a>&nbsp;个</td></tr>
           </tbody>
          </table>
         </div> 
         <div class="Order_Statistics">
          <div class="title_name">商品统计信息</div>
           <table class="table table-bordered">
           <tbody>
           <tr><td class="name">上架商品：</td><td class="munber"><a href="#">${onsale}</a>&nbsp;个</td></tr>
           <tr><td class="name">下架商品：</td><td class="munber"><a href="#">${offsale}</a>&nbsp;个</td></tr>
           </tbody>
          </table>
         </div>
         </div>
