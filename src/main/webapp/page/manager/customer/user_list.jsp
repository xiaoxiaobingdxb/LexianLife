                            ...
                            <td class="td-manage">
                                <c:if test="${users.status == 1}">
                                    <a onClick="member_stop(this,${users.cusId})" href="javascript:;" title="停用"
                                       class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i>停用</a></c:if>
                                <c:if test="${users.status == 0}">
                                    <a onClick="member_start(this,${users.cusId})" href="javascript:;" title="启用"
                                       class="btn btn-xs btn-defaunt"><i class="fa fa-check  bigger-120"></i>启用</a></c:if>
                                <a title="删除" href="javascript:;"  onclick="member_del(this,${users.cusId})" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
