                                ...
                                <ul class="category-list" id="js_climit_li">
                                    <c:forEach var="catalog" items="${sessionScope.catalogs}">
                                        ...
                                        <div class="category-info">
                                            <h3 class="category-name b-category-name"><a class="ml-22" title="${catalog.name}" href="#f${catalog.catalog_id}"><i><img src="${catalog.img}"></i>${catalog.name}</a></h3>
                                            <em>&gt;</em></div>
                                        <div class="menu-item menu-in top">
                                            <div class="area-in">
                                                <div class="area-bg">
                                                    <div class="menu-srot">
                                                        <div class="sort-side">
                                                            <dt><span title="${catalog.name}">${catalog.name}</span></dt>
                                                            <dl class="dl-sort">
                                                                <c:forEach items="${catalog.categories}" var="category">
                                                                    <dd><a title="${category.name}" href="/viewCategory.do?category_id=${category.category_id}&pageIndex=1"><span>${category.name}</span></a></dd>
                                                                </c:forEach>
                                                            </dl>
                                                        </div>
                                                        <div class="brand-side">
                                                           <%-- <dl class="dl-sort"><dt><span>实力商家</span></dt>
                                                                ...
                                                                <c:forEach items="${catalog.categories[0].goods}" var="goods">
                                                                <a href="/viewGoods.do?goods_id=${goods.goodsId}"><img src="${goods.img}" style="width: 100px;height: 100px;"></a>
                                                                </c:forEach>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="am-g am-g-fixed floodThree ">
                        <div class="am-u-sm-4 text-four list">
                            <div class="word">
                                <c:if test="${catalog.categories.size()<6}">
                                    <c:forEach var="category" items="${catalog.categories}">
                                        <a class="outer" href="/viewCategory.do?category_id=${category.category_id}&pageIndex=1"><span class="inner"><b class="text">${category.name}</b></span></a>
                                    </c:forEach>
                                </c:if>
                                <c:if test="${catalog.categories.size()>=6}">
                                    <a class="outer" href="/viewCategory.do?category_id=${catalog.categories[0].category_id}&pageIndex=1"><span class="inner"><b class="text">${catalog.categories[0].name}</b></span></a>
                                    <a class="outer" href="/viewCategory.do?category_id=${catalog.categories[1].category_id}&pageIndex=1"><span class="inner"><b class="text">${catalog.categories[1].name}</b></span></a>
                                    <a class="outer" href="/viewCategory.do?category_id=${catalog.categories[2].category_id}&pageIndex=1"><span class="inner"><b class="text">${catalog.categories[2].name}</b></span></a>
                                    <a class="outer" href="/viewCategory.do?category_id=${catalog.categories[3].category_id}&pageIndex=1"><span class="inner"><b class="text">${catalog.categories[3].name}</b></span></a>
                                    <a class="outer" href="/viewCategory.do?category_id=${catalog.categories[4].category_id}&pageIndex=1"><span class="inner"><b class="text">${catalog.categories[4].name}</b></span></a>
                                    <a class="outer" href="/viewCategory.do?category_id=${catalog.categories[5].category_id}&pageIndex=1"><span class="inner"><b class="text">${catalog.categories[5].name}</b></span></a>
                                </c:if>
                            </div>
