                ...
                <div class="main-wrap">
                    ...
                    <div class="user-address">
                        ...
                        <div class="am-cf am-padding">
                            <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">编辑地址</strong> / <small>Address&nbsp;list</small></div>
                        </div>
                        <hr/>
                        <div class="clear"></div>
                        <!--例子-->
                                    ...
                                    <form class="am-form am-form-horizontal" action="/updateAddr.do" method="post">
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-form-content">
                                                <input type="text" id="user-name" name="recName" placeholder="收货人" value="${sessionScope.editingAddr.recName}">
                                            </div>
                                        </div>
                                        <div class="am-form-group">
                                            <label for="user-phone" class="am-form-label">手机号码</label>
                                            <div class="am-form-content">
                                                <input id="user-phone" name="phone" placeholder="手机号必填" type="text" value="${sessionScope.editingAddr.phone}">
                                            </div>
                                        </div>
                                        <div class="am-form-group">
                                            <label for="postcode" class="am-form-label">邮编</label>
                                            <div class="am-form-content">
                                                <input id="postcode" name="postcode" placeholder="邮政编码" type="text" value="${sessionScope.editingAddr.postcode}">
                                            </div>
                                        </div>
                                        <div class="am-form-group">
                                        ...
                                        <div class="am-form-group">
                                            ...
                                            <div class="am-form-content">
                                                <textarea class="" rows="3" id="user-intro" name="addr" placeholder="输入详细地址">${sessionScope.editingAddr.addr}</textarea>
                                        ...
                                        <div class="am-form-group">
                                            <div class="am-u-sm-9 am-u-sm-push-3">
                                                ...
                                                <a href="/manageAddress.do" class="am-close am-btn am-btn-danger" data-am-modal-close>取消</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
