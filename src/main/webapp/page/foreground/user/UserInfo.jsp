            ...
            <div class="col-main">
                <div class="main-wrap">
                    ...
                    <div class="user-info">
                        ...
                        <hr/>
                        <form class="am-form am-form-horizontal" id="form" action="/customerModify.do" method="post" enctype="multipart/form-data">
                        <!--头像 -->
                            <div class="user-infoPic">
                            <div class="filePic">
                                <input type="file" name="headFile" class="inputPic" allowexts="gif,jpeg,jpg,png,bmp" accept="image/*" onchange="getPhoto(this)">
                            ...
                            <div class="info-m">
                              ...
                              <div class="user-detail">
                                ...
                                <div class="am-form-content">
                                    <input type="text" id="nick_name" name="nickname" placeholder="nickname" value="${sessionScope.customer.nickname}">
                                </div>
                                 </div>
                                 <div class="am-form-group">
                                <label for="real_name" class="am-form-label">真实姓名</label>
                                <div class="am-form-content">
                                    <input type="text" id="real_name" name="realname" placeholder="realname" value="${sessionScope.customer.realname}">
                                </div>
                            </div>
                                 <div class="am-form-group">
                                ...
                                <div class="am-form-content sex">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="sex" value="1" data-am-ucheck <c:if test="${sessionScope.customer.sex==1}">checked</c:if>> 男
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="sex" value="2" data-am-ucheck <c:if test="${sessionScope.customer.sex==2}">checked</c:if>> 女
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="sex" value="0" data-am-ucheck <c:if test="${sessionScope.customer.sex==0}">checked</c:if>> 保密
                                    </label>
                                </div>
                            </div>
                                 <div class="am-form-group">
                                ...
                                <div class="am-form-content birth">
                                    <input type="txt" name="birth" id="datetimepickers" class="am-form-field" value="<fmt:formatDate value="${sessionScope.customer.birth}" type="date"/>">
                                </div>
                                ...
                                <div class="am-form-content">
                                    <input id="phone" placeholder="telephonenumber" name="phone" type="tel" value="${sessionScope.customer.phone}">
                                </div>
                            </div>
                                 <div class="info-btn">
