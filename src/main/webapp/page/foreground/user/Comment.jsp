...
<head>
    ...
    <style>
        ...
        li{list-style: none;}
        /*星星评分*/
        .scoremark{width:154px;position:relative;margin-top:0px;}
        .scoremark .score{
            float: right;
            display: block;
            margin: 0 0 0 10px;
                        ...
                        <div class="comment-main">
                            <c:forEach items="${requestScope.commentOrder.orderItems}" var="orderItem">
                                <c:if test="${orderItem.commented==0}">
                                    ...
                                    <textarea placeholder="请写下对宝贝的感受吧，对他人帮助很大哦！" id="content${orderItem.orderItemId}"></textarea>
                                </div>
                                    ...
                                    <div id="scoremark" class="scoremark score">
                                        <span class="star">
       									...
       									<ul>
       										<li onclick="selectStar(this,'${orderItem.orderItemId}')"><a href="javascript:void(0)" data-name="很差" class="one-star">1</a></li>
        									<li  onclick="selectStar(this,'${orderItem.orderItemId}')"><a href="javascript:void(0)" data-name="较差" class="two-stars">2</a></li>
       										<li onclick="selectStar(this,'${orderItem.orderItemId}')"><a href="javascript:void(0)" data-name="一般" class="three-stars">3</a></li>
        									<li onclick="selectStar(this,'${orderItem.orderItemId}')"><a href="javascript:void(0)" data-name="较好" class="four-stars">4</a></li>
        									<li onclick="selectStar(this,'${orderItem.orderItemId}')"><a href="javascript:void(0)" data-name="很好" class="five-stars">5</a></li>
       									</ul>
      									</span>
                                    ...
                                    <div class="info-btn">
                                        <div class="am-btn am-btn-danger" onclick="submitComment('${orderItem.orderItemId}')">发表评论</div>
                                    </div>
                                </c:if>
                            </c:forEach>
                        </div>
                ...
                <ul>
                    ...
                    <li class="person">
                        ...
                        <ul>
                            ...
                            <%--<li> <a href="billlist.html">账单明细</a></li>--%>
                        </ul>
                    </li>
